...
public final class RenewableLavaConfig {
    ...
    private static boolean write(Path path, RenewableLavaConfig config) {
        try {
            ...
            RenewableLava.LOGGER.warn("Failed to write renewable lava config at {}.", path);
            return false;
        }
    }
    ...
    private record DimensionValidation(Set<Identifier> whitelistDimensions, @Nullable String invalidDimensionId) {
    }
}
